...
DEFAULT_OUTPUT = ROOT / "features" / "orb_codebook_k512.npy"
...
def collect_descriptors(
    ...
    if not descriptors:
        raise RuntimeError("No ORB descriptors collected. Check your images.")
...
def parse_args() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build an ORB Bag-of-Words codebook using faiss.Kmeans."
    )
    parser.add_argument(
        "--db",
        type=pathlib.Path,
    ...
    parser.add_argument(
        ...
        help="File to store the codebook (default: features/orb_codebook_k512.npy).",
    )
    parser.add_argument(
        "--vocab-size",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=200_000,
        help="Maximum total ORB descriptors to collect (default: 200000).",
    )
    parser.add_argument(
        "--max-per-image",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=789,
        help="Random seed for k-means (default: 789).",
    )
